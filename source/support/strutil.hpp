...
inline auto ntos(bool value, const std::string &true_value = "true",
...
template <typename T>
auto ntos(T value, radix_t radix = radix_t::dec, bool prefix = false,
          int size = 0, char pad = '0') -> std::string {
